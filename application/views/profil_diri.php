                                    ...
                                    <div class="col-md-10 col-xs-12">
                                        <form>
                                            ...
                                            <div class="mb-3">
                                              ...
                                              <div id="emailHelp" class="form-text">Color.</div>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                              ...
                                              <div id="emailHelp" class="form-text">Datetime-local.</div>
                                            </div>
                                            <div class="mb-3">
                                              <label for="exampleInputEmail1" class="form-label">file</label>
                                              <input type="file" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                              <div id="emailHelp" class="form-text">file.</div>
                                            </div>
                                            <div class="mb-3">
                                              ...
                                              <div id="emailHelp" class="form-text">hidden.</div>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                              ...
                                              <div id="emailHelp" class="form-text">number.</div>
                                            </div>
                                            <div class="mb-3">
                                              ...
                                              <div id="emailHelp" class="form-text">radio.</div>
                                            </div>
                                            <div class="mb-3">
                                              ...
                                              <div id="emailHelp" class="form-text">range.</div>
                                            </div>
                                            <div class="mb-3">
                                              ...
                                              <div id="emailHelp" class="form-text">reset.</div>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                              ...
                                              <div id="emailHelp" class="form-text">tel.</div>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                              ...
                                              <div id="emailHelp" class="form-text">url.</div>
                                            </div>
                                            <div class="mb-3">
                                              ...
                                              <div id="emailHelp" class="form-text">week.</div>
                                            </div>
                                            <div class="mb-3">
